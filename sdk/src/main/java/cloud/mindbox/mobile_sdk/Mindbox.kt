...
object Mindbox {
    ...
    /**
     * Retrieves push uniq key from intent generated by notification manager
     *
     * @param intent an intent sent by SDK and received in BroadcastReceiver
     * @return url associated with the push intent or null if there is none
     */
    fun getUniqKeyFromPushIntent(intent: Intent?): String? = intent?.let {
        PushNotificationManager.getUniqKeyFromPushIntent(intent)
    }

    /**
     * Retrieves push button uniq key from intent generated by notification manager
     *
     * @param intent an intent sent by SDK and received in BroadcastReceiver
     * @return url associated with the push intent or null if there is none
     */
    fun getUniqPushButtonKeyFromPushIntent(intent: Intent?): String? = intent?.let {
        PushNotificationManager.getUniqPushButtonKeyFromPushIntent(intent)
    }
